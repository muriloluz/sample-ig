...
echo "Validando"
java -jar validador/validator_cli.jar fsh-generated/resources/*.json -version 4.0.1 -ig br.ufg.muriloluz.sample#dev | GREP_COLORS='mt=01;31:ms=01;31' grep -B 1 -A 4 --color=always "[1-9][0-9]* errors"
